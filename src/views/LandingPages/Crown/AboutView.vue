...
const itemList2 = [
  ...
  { id: 12, title: '금(골드)', content: '주로 어금니에 사용하며 구강 내 친화성이 좋아 알레르기 반응이 적습니다. 탄성과 강도가 치아와 유사해 저작시에도 손상이 적지만 치아색과 다르기에 심미성이 떨어진다는 단점이 있습니다.', img: gold },
  { id: 13, title: '지르코니아', content: '앞니, 어금니 모두에 사용하며 인조 다이아몬드라고 불릴 만큼 강도가 단단합니다. 자연치아 와 유사해 심미성이 높고 내구성이 강합니다. 치아 마모 가능성과 투명도가 낮아 탁해 보일 수 있다는 단점 또한 가지고 있습니다.', img: zircon },
];
