...
const itemList = [
  { id: 1, title: '1단계-레진', content: '치아의 가장 바깥쪽 법랑질부터 썩기 시작하며 자각 증상이 없어 간단한 레진 치료가 가능합니다.', img: cavity_material1 },
  ...
  { id: 4, title: '4단계-임플란트', content: '뿌리와 잇몸까지 손상되어 신경조직이 썩어 발치 후 임플란트 수술이 필요합니다.', img: cavity_material4 },
];

// 템플릿 리터럴을 자바스크립트 변수에 할당
const title = "충치치료란?";
const content = `음식을 섭취한 후 남아있는 음식찌꺼기나 치태 속의 세균이 
치아를 부식시켜 충치를 일으킵니다.
이로 인해 잃어버린 치아의 기능과 형태를 회복시켜주는 치료입니다.

충치의 진행단계에 따라 알맞은 치료법을 선택해 치료합니다.`;
