...
<template>
  <section class="py-sm-7" id="pricing-soft-ui">
    ...
    <div class="mt-lg-n8 mt-n6">
      <div class="container">
        <div class="row mt-5">
          <SimplePricingCard title="Freelancer" description="Good for a personal or client web/mobile app."
            :price="{ currency: '$', amount: '79' }" :action="{
              route: '/',
              label: 'Buy now',
          ...
          <SimplePricingCard title="Startup" description="Build your startup or client web/mobile app." :price="149"
            :specifications="[
              'Complete documentation',
              'Full code',
              'Projects - 1',
          ...
          <SimplePricingCard color="bg-gradient-dark" title="Company"
            description="Perfect for web/mobile apps or SaaS projects." :price="249"
            :action="{ route: '', label: 'Buy now', color: 'btn-white' }" :specifications="[
              'Complete documentation',
              'Full code',
              'Use in SaaS',
              'Projects - unlimited',
          ...
          <SimplePricingCard title="Enterprise" description="Deploy large-scale projects which include redistribution
                    rights." :price="599" :action="{
                      route:
